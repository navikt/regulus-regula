...
fun getRule(rules: HprRule): HprRuleFn {
    return when (rules) {
        ...
        HprRule.BEHANDLER_ER_FT_MED_TILLEGSKOMPETANSE_I_HPR -> Rules.behandlerErFTMedTilligskompetanseSykmelding
        HprRule.BEHANDLER_ER_KI_MED_TILLEGSKOMPETANSE_I_HPR -> Rules.behandlerErKIMedTilligskompetanseSykmelding
...
private val Rules = object {
    ...
    val behandlerErFTMedTilligskompetanseSykmelding: HprRuleFn = { payload ->
        ...
        val erFtMedTilleggskompetanse = erHelsepersonellKategoriMedTilleggskompetanse(
    ...
    val sykefravarOver12Uker: HprRuleFn = { payload ->
        ...
        val over12Uker = daysBetween(forsteFomDato, sisteTomDato) > 84
                || (behandlerStartDato != null && daysBetween(behandlerStartDato, sisteTomDato) > 84)
