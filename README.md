...
graph TD
    ...
    root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_SYKMELDER_HAR_AUTORISASJON_I_HPR_SYKMELDER_ER_LEGE_I_HPR(SYKMELDER_ER_LEGE_I_HPR) -->|Ja| root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_SYKMELDER_HAR_AUTORISASJON_I_HPR_SYKMELDER_ER_LEGE_I_HPR_OK(OK):::ok
    ...
    root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_SYKMELDER_HAR_AUTORISASJON_I_HPR(SYKMELDER_HAR_AUTORISASJON_I_HPR) -->|Nei| root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_SYKMELDER_HAR_AUTORISASJON_I_HPR_INVALID(Ugyldig):::invalid
    root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_SYKMELDER_HAR_AUTORISASJON_I_HPR(SYKMELDER_HAR_AUTORISASJON_I_HPR) -->|"Nei (papir)"| root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_SYKMELDER_HAR_AUTORISASJON_I_HPR_INVALID_papir(Manuell behandling):::manuell
    root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR(SYKMELDER_GYLIDG_I_HPR) -->|Nei| root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_INVALID(Ugyldig):::invalid
    root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR(SYKMELDER_GYLIDG_I_HPR) -->|"Nei (papir)"| root_SYKMELDER_FINNES_I_HPR_SYKMELDER_GYLIDG_I_HPR_INVALID_papir(Manuell behandling):::manuell
    root(SYKMELDER_FINNES_I_HPR) -->|Nei| root_SYKMELDER_FINNES_I_HPR_INVALID(Ugyldig):::invalid
    root(SYKMELDER_FINNES_I_HPR) -->|"Nei (papir)"| root_SYKMELDER_FINNES_I_HPR_INVALID_papir(Manuell behandling):::manuell
    classDef ok fill:#c3ff91,stroke:#004a00,color: black;
    classDef invalid fill:#ff7373,stroke:#ff0000,color: black;
    classDef manuell fill:#ffe24f,stroke:#ffd500,color: #473c00;
```
